...
<body>
            ...
            <nav class="navbar navbar-light"  style="background:transparent;">
                <div class="container-fluid">
                    <form class="d-flex" action="" method="POST">
                        <input class="form-control me-4" type="search" name="interest" placeholder="Search by Skill" style = "" aria-label="Search" />
    ...
    <?php 
        ...
        if(isset($_POST['submit']))
        {
            ...
            $query = "SELECT * FROM `employee` WHERE (interest1 like '%$interest%' || interest2 like '%$interest%' || interest3 like '%$interest%') && city like '%$jloc%' ";
